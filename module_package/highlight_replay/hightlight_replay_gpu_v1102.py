...
class Highlight_Repleay:
    ...
    def get_region_param(self):
        ...
        if self.replayId == '1B':
            ...
            spotBottomL,spotBottomR = (2224,1011),(4084,1254)    
    ...
    def receive_frame_info(self,count,exportedData,verbose=0):
        ...
        print ('{} HihtLight Replay is running.'.format(self.replayId))
...
class Data_Contrller:
    ...
    def get_init_para(self):
        if replayId == '1B':
            ...
            self.hightCount = 2400 # 1B count:907 捕手漏接跑向一壘
...
#            self.imageDirPath = './190929_NAS/NAS04/20190929_19_41-42/'
            ...
            self.imageDirPath = './NAS_data_new/NAS04_20191102_14-2/'
            

        elif replayId == '3B':
            self.hightCount = 490 # 1B count:907 捕手漏接跑向一壘
