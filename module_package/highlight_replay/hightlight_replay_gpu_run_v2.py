...
class Highlight_Repleay:
    ...
    def __init__(self,replayId='1B',saveHighLight = False):
        ...
        if self.replayId == 'HB':
            ...
            # ver run
            # self.trackingDistance = 250
            
            # ver modify cam
            self.trackingDistance = 560
            
        elif self.replayId == '2B':
            self.initTrackingPoint.append((self.spotBottomR[0],int(round((self.spotBottomR[1]+self.spotTopR[1])/2))))
    ...
    def get_region_param(self):
        ...
        if self.replayId == '1B':
            ...
            #ver4-2
            spotBottomL,spotBottomR = (2204,1119),(2855,1223)
            spotTopL,spotTopR = (2415,989),(2878,1063)
            ...
            #ver4-2
            spotBottomL,spotBottomR = (3103,1052),(3835,1017)
            spotTopL,spotTopR = (3024,1170),(3890,1171)
            ...
            #ver4-2
            spotBottomL,spotBottomR = (817,1177),(1238,1170)
            spotTopL,spotTopR = (726,825),(1211,863)
            ...
            if isInsideRegion1 and classLable == 0:
                if self.lastTrackingPoint == None:
                    for point in self.initTrackingPoint:
                        self.conditionRegionPointsInfo.append((footPoint,point,_two_points_length(footPoint,point)))
                else:
                    self.conditionRegionPointsInfo.append((footPoint,self.lastTrackingPoint,_two_points_length(footPoint,self.lastTrackingPoint)))
...
class Data_Contrller:
    ...
    def get_init_para(self):
        if replayId == '1B':
            self.hightCount = 265 # 1B count:907 捕手漏接跑向一壘
...
#            self.imageDirPath = './191001_NAS/NAS02_20191001_18-39/'
            self.imageDirPath = './NAS_data/NAS02_20190925_20-36/'
...
#            self.imageDirPath = './190929_NAS/NAS04/20190929_19_41-42/'
            self.imageDirPath = './NAS_data/NAS04_20190925_20-36/'

        elif replayId == '3B':
            self.hightCount = 351 # 1B count:907 捕手漏接跑向一壘
...
#            self.imageDirPath = './190929_NAS/NAS12/20190929_19_41-42/'
            self.imageDirPath = './NAS_data/NAS12_20190925_20-36/'

        elif replayId == 'HB':
            self.hightCount = 145 # 1B count:907 捕手漏接跑向一壘
...
#            self.imageDirPath = './191001_NAS/NAS03_20191001_18_38-39/'
            self.imageDirPath = './NAS_data/NAS03_20190925_20-36/'
...
def save_YOLO_result():
#    print ('count:',str(count))
#    bbox_info = YOLO.detect_img(yolov3, frame, save_img=False)
#    save_list = [imagePath]
#    for v in bbox_info:
#        save_list.append(v)
#    pickle.dump(save_list,open('./NAS04_20191001_08-26.pkl',"ab"))
    pass
    ...
    while True:
        if count % 1 == 0:
            ...
            if imagePath != False:
                ...
                highlightFlag = HR.receive_frame_info(count,exportedData,verbose=1)
