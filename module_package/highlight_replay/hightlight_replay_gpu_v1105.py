...
class Highlight_Repleay:
    ...
    def __init__(self,replayId='1B',saveHighLight = False):
        ...
        if self.replayId == 'HB':
            initX = self.spotBottomL[0] +130 #946
    ...
    def get_region_param(self):
        ...
        if self.replayId == '1B':
            ...
            spotBottomL,spotBottomR = (2224,1055),(4084,1295)    
            ...
            spotBottomL,spotBottomR = (2689,1055),(4027,1031)
            spotTopL,spotTopR = (2657,1170),(4065,1171)
            ...
            #ver4-2
            spotBottomL,spotBottomR = (625,1177),(1949,1180)
            spotTopL,spotTopR = (587,744),(2023,913)
    ...
    def receive_frame_info(self,count,exportedData,verbose=0):
        ...
        print ('<< {} >> Replay is running.'.format(self.replayId))
...
#        region_image = cv2.bitwise_and(region_image,region_image, mask=mask)
    ...
    def update_condition2(self):
        ...
        if len(self.conditionRegionPointsInfo) > 0:
            if self.lastTrackingPoint != None:
                ...
                if len(trackingPointInfos) > 0 :
                    matchTrackingPointInfos = [v for v in trackingPointInfos if v[2] > self.runDis and v[2] < 550]
        ...
        # print ('>> c2:',self.lastTrackingPoint,isForward)
...
class Data_Contrller:
    ...
    def get_init_para(self):
        if replayId == '1B':
            self.hightCount = 1230 # 1B count:907 捕手漏接跑向一壘
    ...
    while True:
        if count % 1 == 0:
            ...
            if imagePath != False:
                ...
                highlightFlag = HR.receive_frame_info(count,exportedData,verbose=0)
