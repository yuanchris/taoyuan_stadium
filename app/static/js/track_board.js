...
socket.on('send_track', function(msg) {
    ...
    // $("#mysvg").empty();
    mysvg.innerHTML = '<image width="557" height="492" xlink:href="/static/img/field_taoyuan.svg"/>'
    ...
    if (typeof msg['pause_start'] !== 'undefined') {
        ...
        for (let key  in msg) {
            if (msg[key][2]) {
                ...
                let text= makeText('text', {x: circle_x + 7, y: circle_y + 2, fill: 'black', style:"font-size: 8px"}, msg[key][3]);
